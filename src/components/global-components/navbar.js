				...
				<div className="row">
					...
					<div className="site-logo-wrap">
						...
						<div className="get-support-info">
							<h6>Get Support</h6>
							<h4><a href="tel:+9715 5250 5878">+9715 5250 5878</a></h4>
						</div>
						</div>
					</div>
					</div>
					...
					<div className="header-menu d-none d-xl-block">
						...
						<div className="ltn__main-menu go-top">
							<ul>
							<li className="menu"><Link to="">HOME</Link>
							...
							<li className="menu"><Link to="/about">ABOUT</Link>
								<ul>
							...
							<li className="menu"><Link to="#">PROPERTY</Link>
								...
								<li className="menu"><Link to="/shop">NEWS</Link>
								<ul>
									<li><Link to="/shop">Shop</Link></li>
									<li><Link to="/shop-grid">Shop Grid</Link></li>
									<li><Link to="/shop-left-sidebar">Shop Left sidebar</Link></li>
							...
							<li className="menu"><Link to="/blog-grid">TEAM</Link>
								<ul>

			            ...
			            <div className="col-lg-12 align-self-center">
			              <div className="slide-item-info">
			                <div className="slide-item-info-inner ltn__slide-animation">
			                  ...
			                  <h6 className="slide-sub-title white-color--- animated"><span><i className="fas fa-home" /></span> Good Morning Property Real Estate</h6>
			                  <h1 className="slide-title animated ">Your Gateway to Dubai <br /> Real Estate</h1>
			                  <div className="slide-brief animated">
			                    <p>Discover an extensive range of real estate options in Dubai, from luxurious penthouses to charming garden apartments</p>
			                  </div>
			          ...
			          <div className="row">
			            <div className="col-lg-12 align-self-center">
			              <div className="slide-item-info">
			                <div className="slide-item-info-inner ltn__slide-animation">
							<h6 className="slide-sub-title white-color--- animated"><span><i className="fas fa-home" /></span> Good Morning Property Real Estate</h6>
			                  <h1 className="slide-title animated ">Where Serenity Meets  <br /> Real Estate</h1>
			                  <div className="slide-brief animated">
			                    <p>Discover a selection of properties in tranquil neighborhoods, perfect for those seeking a peaceful retreat amidst Dubai's bustling cityscape.</p>
			                  </div>
			                  <div className="btn-wrapper animated go-top">
			                    <Link to="/shop" className="theme-btn-1 btn btn-effect-1">Make An Enquiry</Link>
			                  </div>
			          ...
			          <div className="row">
			            <div className="col-lg-12 align-self-center">
			              <div className="slide-item-info">
			                <div className="slide-item-info-inner ltn__slide-animation">
							<h6 className="slide-sub-title white-color--- animated"><span><i className="fas fa-home" /></span> Good Morning Property Real Estate</h6>
			                  <h1 className="slide-title animated ">Blooming Gardens,  <br /> Endless Possibilities</h1>
			                  <div className="slide-brief animated">
			                    <p>Properties invites you to explore a world of lush gardens and picturesque homes. Find your piece of paradise in Dubai with properties that embrace nature's beauty.</p>
			                  </div>
			                  <div className="btn-wrapper animated go-top">
			                    <Link to="/shop" className="theme-btn-1 btn btn-effect-1">Make An Enquiry</Link>
			                  </div>
